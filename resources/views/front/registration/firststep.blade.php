...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0" style="background:url('{{asset('gallery/IMG20230908094639.jpg')}}');background-repeat: no-repeat;background-size: cover;background-position: center;">
  ...
  <div class="headerBox">
    ...
    <center style="height: 100%;display: flex; justify-content: center; align-items: center;color: #fff;font-size: 28px;">Vaish Model Sr. Sec. School Bhiwani</center>
  </div>
  ...
  {{-- <video  autoplay muted loop style="height: 80%;width: 90%;"> --}}
      <img src="{{asset('gallery/IMG20230908094607_2.jpg')}}" style="height: 80%;width: 90%;">
    {{-- </video> --}}
  </div>
